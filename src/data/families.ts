...
export const families: Family[] = [
  ...
  },
  {
    slug: 'energy',
    name: 'Energy & Laser',
    essence: 'RF microneedling, fractional CO₂, picosecond and dual-wavelength lasers.',
    accentVar: 'energy',
    reads: 'light / energy',
  },
  {
    slug: 'clinical',
    name: 'Plasma & Lesions',
    essence: 'Plasma soft surgery and vascular or lesion removal.',
    accentVar: 'clinical',
    reads: 'medical',
  },
  {
    slug: 'skin',
    name: 'Facials & Peels',
    essence: 'Hydradermabrasion, medical peels, and prep facials in a clinical setting.',
    accentVar: 'skin',
    reads: 'glow',
  },
  {
    slug: 'health',
    name: 'Skin Health',
    essence: 'Medical-grade actives, prescribed and reviewed.',
    accentVar: 'health',
    reads: 'clarity',
  },
];
